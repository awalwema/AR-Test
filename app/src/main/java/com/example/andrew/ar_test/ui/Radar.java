...
import com.example.andrew.ar_test.activity.AugmentedReality;
import com.example.andrew.ar_test.camera.CameraModel;
import com.example.andrew.ar_test.common.Orientation.ORIENTATION;
import com.example.andrew.ar_test.data.ARData;
import com.example.andrew.ar_test.data.ScreenPosition;
import com.example.andrew.ar_test.ui.objects.PaintableCircle;
import com.example.andrew.ar_test.ui.objects.PaintableLine;
import com.example.andrew.ar_test.ui.objects.PaintablePosition;
import com.example.andrew.ar_test.ui.objects.PaintableRadarPoints;
import com.example.andrew.ar_test.ui.objects.PaintableText;
...
public class Radar {
    ...
    public static final float RADIUS = 175;
    ...
    private static final int RADAR_COLOR = Color.argb(150, 0, 0,0);
